...
This repository contains two branches ; LoginTemplate1 and LoginTemplateV2. LoginTemplate1 is based on a simple Bootstrap 3 and LoginTemplateV2 is based on Bootstrap 4. Switch branches to view/download details.To access each branch,  click the  "Branch"  pulldown menu on the upper left corner.
